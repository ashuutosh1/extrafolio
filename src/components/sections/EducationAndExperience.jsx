...
function EducationAndExperience() {
  return (
    <>
      ...
      <section className="mt-20 mx-4 lg:mx-20 flex flex-col md:flex-row gap-4 md:gap-20">
        {/* =========== EDUCATION =========== */}
        <div className="w-full md:w-[80%]">
          {/* =========== EDUCATION TITLE =========== */}
          <h4 className="text-xl dark:text-white mb-4 font-bold flex gap-2 items-center">
            <FaLandmark className="text-xl text-indigo-400 dark:text-indigo-400" />
            Education
          </h4>
          ...
          <h4 className="text-xl dark:text-white mt-6 font-bold flex gap-2 items-center">
            <PiCertificateFill className="text-2xl text-indigo-400 dark:text-indigo-400" />
            Certificates
          </h4>
          ...
          >
            ...
            <div className="hs-carousel-pagination flex justify-center absolute bottom-3 start-0 end-0 space-x-2">
              {user_info.certificates.map((cert, index) => {
                return (
                  <span
                    className="hs-carousel-active:bg-red-700 hs-carousel-active:border-red-700 size-3 border border-gray-400 rounded-full cursor-pointer dark:border-neutral-600 dark:hs-carousel-active:bg-indigo-400 dark:hs-carousel-active:border-indigo-400"
                    key={index}
                  ></span>
                );
              })}
        ...
        <div className="w-full">
          {/* =========== EXPERIENCE TITLE =========== */}
          <h4 className="text-xl dark:text-white mb-4 font-bold flex gap-2 items-center">
            <FaBuildingUser className="text-2xl text-indigo-400 dark:text-indigo-400" />
            Experience
          </h4>
                        ...
                        {exp.descriptions.map((desc, index) => {
                          return (
                            <li className="flex space-x-3" key={index}>
                              <svg
                                className="flex-shrink-0 size-4 mt-0.5 text-indigo-400 dark:text-indigo-400"
                                xmlns="http://www.w3.org/2000/svg"
                                width="24"
                                height="24"
                                viewBox="0 0 24 24"
